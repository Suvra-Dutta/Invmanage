    ...
    <body class="bg-light-gray" id="body">
        <div class="container d-flex flex-column justify-content-between vh-100">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-4">
                                        <input type="text" class="form-control input-lg" name="name" aria-describedby="nameHelp" placeholder="Name" required autofocus autocomplete="name">
                                    </div>
                                    <div class="form-group col-md-12 mb-4">
                                        <input type="email" class="form-control input-lg" name="email" aria-describedby="emailHelp" placeholder="Email" required>
                                    </div>
            ...
            <div class="copyright pl-0">
                <p class="text-center">&copy; Copyright Invmanage Dashboard Template by
