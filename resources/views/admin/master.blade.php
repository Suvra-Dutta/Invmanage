...
<html lang="en" dir="ltr">
    <head>
        ...
        <title>Invmanage - Admin Dashboard Template</title>
            ...
            <div class="page-wrapper">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <li class="dropdown-header">
                                            ...
                                            <div class="d-inline-block">
                                                Invmanage <small class="pt-1">{{ Auth::user()->email }}</small>
                                            </div>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="{{ route('password.changeform') }}">
                ...
                <footer class="footer mt-auto">
                    <div class="copyright bg-white">
                        <p>
                            &copy; <span id="copy-year">2022</span> Copyright Invmanage Dashboard Template by
